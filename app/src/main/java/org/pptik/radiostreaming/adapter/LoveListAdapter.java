...
public class LoveListAdapter extends BaseAdapter
{
    ...
    public ArrayList<StasiunRadio> mRadioName = null;
    
    private LayoutInflater mInflater = null;
    
    private DBManager mDBManager = null;
    
    public LoveListAdapter(Context context, ArrayList<StasiunRadio> mRadioName)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        ViewRadioName = mRadioName.get(position).getNama();
